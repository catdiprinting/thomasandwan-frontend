            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <Link href="/practice-areas/birth-injuries">
                <div className="bg-white p-6 border border-gray-200 hover:border-secondary hover:shadow-lg transition-all cursor-pointer">
                  <h3 className="font-serif text-xl text-primary mb-2">Birth Injuries</h3>
                  <p className="text-slate-600 text-sm">Preventable injuries to babies during delivery.</p>
                </div>
              </Link>
