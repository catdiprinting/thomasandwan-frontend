        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-start max-w-5xl mx-auto">
          ...
          <div className="group">
            <div className="relative mb-8 overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 bg-primary text-white p-4 min-w-[200px] z-20">
                <h3 className="font-serif text-xl">Linda Laurent Thomas</h3>
                <p className="text-secondary text-sm uppercase tracking-wider">Partner</p>
              </div>
            </div>
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-6 font-light">
              ...
              She specializes in cases involving personal injuries, wrongful death, and medical malpractice.
            </p>
          ...
          <div className="group md:mt-16">
            <div className="relative mb-8 overflow-hidden">
              ...
              />
              <div className="absolute bottom-0 left-0 bg-primary text-white p-4 min-w-[200px] z-20">
                <h3 className="font-serif text-xl">Michelle W. Wan</h3>
                <p className="text-secondary text-sm uppercase tracking-wider">Partner</p>
              </div>
            </div>
            
            <p className="text-lg text-slate-600 leading-relaxed mb-6 font-light">
              Michelle W. Wan has worked exclusively representing clients in personal injury matters. 
