        ...
        <section className="py-20 md:py-28 bg-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              ...
              >
                <div className="inline-flex items-center gap-2 text-secondary text-sm uppercase tracking-[0.2em] mb-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4 md:gap-5 mb-12 md:mb-16">
                {parsed.questions.map((question, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4 p-5 md:p-6 rounded-lg bg-gray-50 border border-gray-200 transition-all duration-300 hover:bg-gray-100 hover:border-secondary/30">
              ...
              >
                {parsed.context && (
                  <p className="text-gray-500 text-base md:text-lg leading-relaxed max-w-2xl mx-auto mb-6">
                    {parsed.context}
                  </p>
                )}
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  />
                  <span className="hidden md:inline-flex items-center gap-2 text-gray-500 text-base">
