...
import BrainInjuries from "@/pages/BrainInjuries";
import SurgicalErrors from "@/pages/SurgicalErrors";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/cases-we-handle/brain-injuries" component={BrainInjuries} />
      <Route path="/cases-we-handle/surgical-errors" component={SurgicalErrors} />
      <Route path="/cases-we-handle/medication-errors" component={MedicationErrors} />
